...
class GlassesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("cap1.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("cap2.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("cap3.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("cap4.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("ggg.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("glass1.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("glass2.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hair1.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hair2.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hair3.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hair4.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hair5.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("lente_color.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("mask.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("sunglass1.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("sunglass2.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                glasses.add(modelRenderable)
                modelRenderable.isShadowCaster = false
